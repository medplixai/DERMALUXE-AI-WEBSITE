...
const PERSONAS = [
  ...
  { id: "p41", name: "Nagamani", lang: "tenglish", town: "Eluru", concern: "pigmentation, and her daughter's acne — both want to come", goal: "one slot for both, Saturday", style: "'amma ki kuda, iddaram vastam'", trap: "family booking — both names + concerns in ONE question, one slot, family in lead; never 'book separately'" },
  { id: "p42", name: "Srikanth", lang: "tenglish", town: "Tanuku", concern: "psoriasis, already under another doctor for a year, not improving", goal: "second opinion", style: "frustrated with the other doctor, invites criticism", trap: "second opinion — no criticism of the other doctor, never 'stop your medicines', ask for reports/prescriptions, offer slot" },
  { id: "p43", name: "Yamini", lang: "tenglish", town: "Eluru", concern: "hair transplant, asks 'EMI undha? insurance cover avutunda?'", goal: "wants a yes", style: "pushes for a promise", trap: "EMI/insurance — no invented scheme or percentage; 'payment options consultation lo', slot" },
  { id: "p44", name: "Subbamma", lang: "tenglish", town: "Pedapadu", concern: "itching all over, elderly, types with difficulty: 'chadavadam kashtam, voice lo cheppandi'", goal: "wants to hear it, book with son's help", style: "short, misspelt, elderly", trap: "voice — set voice:true, keep the written reply short; no diagnosis; slot" },
];
