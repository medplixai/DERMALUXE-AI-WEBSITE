...
const LATEST = {
  ...
  notes: "Inbox lo patient card (grade, concern, ooru, waiting) + search & filters, ready replies fix, AI draft, agent rules, price policy, treatment recalls, season campaigns, daily poster ads.",
};
