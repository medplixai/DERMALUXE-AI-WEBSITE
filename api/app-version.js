...
const LATEST = {
  ...
  notes: "Leads lo ⏳ Waiting group + tiles tap chesthe aa group, Inbox lo patient card + search & filters, ready replies, AI draft, price policy, treatment recalls, campaigns, daily poster ads.",
};
