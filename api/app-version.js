...
const LATEST = {
  ...
  notes: "Appointments roju plan — khaali times + evarini book cheyyalo records batti, Leads ⏳ Waiting group, Inbox patient card + search, AI draft, treatment recalls, campaigns, daily poster ads.",
};
