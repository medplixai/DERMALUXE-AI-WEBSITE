...
const CAP_TE = {
  ...
  "pkg.log": "సెషన్ నమోదు", "reports.view": "నంబర్లు / రిపోర్ట్‌లు", "money.view": "కలెక్షన్ & బాకీలు", "money.bill": "బిల్ & పేమెంట్", "money.expense": "ఖర్చులు & మిగిలింది",
...
const BUILTIN_ROLES = {
  ...
  manager:   { label: "Manager",   te: "మేనేజర్",     note: "Clinic mottam nadipevaru. Delete tappa dadapu anni.",
    caps: ["leads.view","leads.edit","appts.view","appts.edit","pkg.log","academy.view","academy.edit","academy.seats","academy.money","academy.docs","academy.material","academy.certify","money.view","money.bill","money.expense","reports.view","posts.view","posts.toggle","reviews.view","ai.use","msg.send","team.manage"] },
  ...
  accounts:  { label: "Accounts",  te: "అకౌంట్స్",    note: "Fees, receipts, documents. Leads edit cheyaleru.",
    caps: ["leads.view","appts.view","academy.view","academy.money","academy.docs","money.view","money.bill","money.expense","reports.view","reviews.view","ai.use"] },
  therapist: { label: "Therapist", te: "థెరపిస్ట్",   note: "Treatments chese vaaru — chudatam matrame.",
    caps: ["leads.view","appts.view","pkg.log","posts.view","ai.use"] },
