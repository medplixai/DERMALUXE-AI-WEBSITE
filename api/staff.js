...
const CAP_TE = {
  ...
  "pkg.log": "సెషన్ నమోదు", "reports.view": "నంబర్లు / రిపోర్ట్‌లు", "money.view": "కలెక్షన్ & బాకీలు", "money.bill": "బిల్ & పేమెంట్", "money.expense": "ఖర్చులు & మిగిలింది", "stock.view": "స్టాక్ చూడటం", "stock.edit": "స్టాక్ మార్చటం", "attend.manage": "అందరి హాజరు",
...
const CAP_GROUPS = [
  ...
  { key: "clinic",  label: "Clinic",            te: "క్లినిక్",       caps: ["stock.view", "stock.edit", "attend.manage"] },
...
const BUILTIN_ROLES = {
  ...
  manager:   { label: "Manager",   te: "మేనేజర్",     note: "Clinic mottam nadipevaru. Delete tappa dadapu anni.",
    caps: ["leads.view","leads.edit","appts.view","appts.edit","pkg.log","academy.view","academy.edit","academy.seats","academy.money","academy.docs","academy.material","academy.certify","money.view","money.bill","money.expense","reports.view","stock.view","stock.edit","attend.manage","posts.view","posts.toggle","reviews.view","ai.use","msg.send","team.manage"] },
  doctor:    { label: "Doctor",    te: "డాక్టర్",     note: "Consultations + academy training. Money/settings ledu.",
    caps: ["leads.view","leads.edit","appts.view","appts.edit","pkg.log","stock.view","stock.edit","academy.view","academy.edit","academy.material","academy.certify","reviews.view","ai.use","msg.send"] },
  reception: { label: "Reception", te: "రిసెప్షన్",   note: "Front desk — calls, appointments, seat count.",
    caps: ["leads.view","leads.edit","appts.view","appts.edit","pkg.log","stock.view","stock.edit","academy.view","academy.seats","money.view","money.bill","posts.view","ai.use","msg.send"] },
  ...
  therapist: { label: "Therapist", te: "థెరపిస్ట్",   note: "Treatments chese vaaru — chudatam matrame.",
    caps: ["leads.view","appts.view","pkg.log","stock.view","stock.edit","posts.view","ai.use"] },
